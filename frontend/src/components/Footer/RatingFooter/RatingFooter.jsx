...
function RatingBanner() {
  ...
  // Calcular el número de estrellas completas y vacías
const getStars = (rating) => {
  ...
  // Obtener las estrellas para la valoración media
  ...
  <>
    ...
    <div className="bg-white bg-opacity-80 text-black rounded-lg px-6 py-4 flex items-center justify-between w-auto">
        <div className="text-center">
          ...
          ⭐ ¿Te ha gustado WonderFly? ¡Déjanos tu voto!
          </p>
          ...
          <div className="flex justify-center mt-2">
            ...
            {averageRating !== null && numVotes !== null && (
              <p className="text-sm ml-2">({numVotes} votos)</p>
            )}
          </div>
        </div>
        <Link
